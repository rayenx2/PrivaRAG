...
│  React+Vite │                                 │            │
│  :3000      │   FastAPI Backend   :8000        │ qdrant-    │
│             │   ├── OCR (PyMuPDF + Tesseract)  │ data       │
│             │   ├── Embeddings (bge-m3 + GPU)  │            │
│             │   ├── RAG Pipeline (LangChain)   │ backend-   │
│             │   ├── Auth (JWT + bcrypt RBAC)   │ uploads    │
│             │   ├── Backup Scheduler (APSched) │            │
│             │   └── Admin API                  │ hf-cache   │
│             │                                  │            │
│             │   Qdrant             :6333        │            │
│             │   └── Vector store               │            │
